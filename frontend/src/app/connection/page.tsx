  ...
  return (
    <div className="p-8">
      ...
      <div className="max-w-2xl">
        ...
        {/* Mock QR for Demo if no real QR */}
        {!qrCode && status.state !== "ready" && (
          <div className="bg-white rounded-lg shadow p-6 text-center">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">
              WhatsApp QR Code
            </h3>
            <div className="inline-block p-4 bg-gray-100 rounded-lg">
              <div className="w-64 h-64 bg-white border-2 border-dashed border-gray-300 flex items-center justify-center">
            ...
            <p className="mt-4 text-sm text-gray-600">
              QR code will appear here when WhatsApp client initializes
            </p>
          </div>
        )}
      </div>
